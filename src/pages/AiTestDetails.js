...
const messages = [
  {
    id: 1,
    text: t("aitests.modals.quickMessages.testResultReady") || "Test result is ready",
    borderColor: "#ffc107",
    bgColor: "#fff3cd",
    textColor: "#856404",
  },
  {
    id: 2,
    text: t("aitests.modals.quickMessages.followUpRecommended") || "Follow-up is recommended",
    borderColor: "#28a745",
    bgColor: "#d4edda",
    textColor: "#155724",
  },
  {
    id: 3,
    text: t("aitests.modals.quickMessages.contactHealthCenter") || "Please contact the health center",
    borderColor: "#dc3545",
    bgColor: "#f8d7da",
    textColor: "#721c24",
  },
...
>
  <h4 className="mb-4"> {t("aitests.titles.aiTests")}</h4>

  <input
    type="text"
    placeholder={t("aitests.placeholders.searchHere")}
  ...
  <div className="d-flex flex-wrap gap-3 mb-3 align-items-center">
    ...
    <select
      ...
      style={{ width: "150px" }}
    >
      <option value="">{t("aitests.options.allResults")}</option>
      <option value="Positive">{t("aitests.options.positive")}</option>
      <option value="Negative">{t("aitests.options.negative")}</option>
    </select>
    <div
      style={{
        position: "relative",
    ...
    >
      ...
      >
        <tr>
          ...
          >
            {t("aitests.tableHeaders.testNumber")}
          </th>
          <th
            className="py-3"
            style={{ color: "#a8a5a5ff", backgroundColor: "#f0f0f0", borderBottom: "none" }}
          >
            {t("aitests.tableHeaders.testDate")}
          </th>
          <th
            className="py-3"
            style={{ color: "#a8a5a5ff", backgroundColor: "#f0f0f0", borderBottom: "none" }}
          >
            {t("aitests.tableHeaders.aiResult")}
          </th>
          <th
            className="py-3"
            style={{ color: "#a8a5a5ff", backgroundColor: "#f0f0f0", borderBottom: "none" }}
          >
            {t("aitests.tableHeaders.aiDetails")}
          </th>
          <th
            className="py-3"
            style={{ color: "#a8a5a5ff", backgroundColor: "#f0f0f0", borderBottom: "none" }}
          >
            {t("aitests.tableHeaders.call")}
          </th>
          <th
            className="py-3"
            style={{ color: "#a8a5a5ff", backgroundColor: "#f0f0f0", borderBottom: "none" }}
          >
            {t("aitests.tableHeaders.notification")}
          </th>
          <th
            className="py-3"
            style={{ color: "#a8a5a5ff", backgroundColor: "#f0f0f0", borderBottom: "none" }}
          >
            {t("aitests.tableHeaders.chat")}
          </th>
          <th
            className="py-3"
            style={{ color: "#a8a5a5ff", backgroundColor: "#f0f0f0", borderBottom: "none" }}
          >
            {t("aitests.tableHeaders.appointment")}
          </th>
        </tr>
      </thead>
        ...
        {filteredTests.length > 0 ? (
          filteredTests.map((test) => (
            ...
            >
              ...
              <td
                ...
                title={t("aitests.tooltips.details")}
              >
                {'DETAILES'}
              </td>
              <td className="py-3">
              ...
              <td className="py-3">
                <FaBell
                  ...
                  title={t("aitests.tooltips.notification")}
                />
              </td>
              <td className="py-3">
                <FaCommentDots
              ...
              <td className="py-3">
                <FaCalendarPlus
                  ...
                  title={t("aitests.tooltips.appointment")}
                />
              </td>
            </tr>
          ))
          ...
          <tr>
            <td colSpan="8" className="py-4">
              {t("aitests.tableMessages.noTests")}
            </td>
          </tr>
        )}
      </tbody>
  ...
  <Modal show={showNotificationModal} onHide={closeModal} centered size="lg">
    <Modal.Header closeButton className="flex-column align-items-start" style={{ border: "none" }}>
      <Modal.Title className="fs-4 fw-bold mb-1">
        {t("aitests.modals.notification")} {selectedTest?.id}
      </Modal.Title>
      <p className="text-muted mb-0">{t("aitests.modals.pleaseFillNote")}</p>
    </Modal.Header>
    ...
    <Modal.Body>
      ...
      <div className="mb-3">
        <label htmlFor="noteInput" className="form-label fw-semibold">
          {t("aitests.modals.sendToUser")} <strong>{selectedTest?.user?.name}</strong>
        </label>
        <textarea
          id="noteInput"
          className="form-control"
          rows="4"
          placeholder={t("aitests.placeholders.writeHere")}
          value={note}
      ...
      {/* Quick Messages */}
      <div>
        <p className="fw-semibold mb-3">{t("aitests.modals.quickMessage")}:</p>
    ...
    <Modal.Footer className="justify-content-center">
      ...
      >
        <FaFileAlt className="me-1" /> {t("aitests.buttons.add")}
      </Button>
    </Modal.Footer>
  </Modal>
        ...
        <>
          <div className="mb-3">
            <h2 className="text-center" style={{ padding: "10px" }}>
              {t("aitests.modals.bloodTestResult")}
            </h2>
            <p>
              {t("aitests.modals.patientName")}: {selectedTest.user.name || "-"}
            </p>
            <p>
              {t("aitests.modals.caseID")}: {selectedTest.test_number || "—"}
            </p>
            <p>
{t("aitests.modals.reportDate")}: {selectedTest.test_date ? selectedTest.test_date : new Date().toLocaleDateString()}
            </p>
            <hr />
          </div>
            ...
            <thead className="table-light">
              <tr>
                <th style={{ border: "none", textAlign: "left", width: "33.3%" }}>
                  {t("aitests.tableHeaders.testName")}
                </th>
                <th style={{ border: "none", textAlign: "center", width: "33.3%" }}>
                  {t("aitests.tableHeaders.result")}
                </th>
                <th style={{ border: "none", textAlign: "center", width: "33.3%" }}>
                  {t("aitests.tableHeaders.standard")}
                </th>
              </tr>
            </thead>
            <tbody>
    ...
    <Modal.Footer className="justify-content-center">
      <Button
        ...
        className="me-2"
        onClick={() => alert(t("aitests.alerts.sendReportClicked"))}
      >
        <FaFileAlt className="me-1" /> {t("aitests.buttons.sendReport")}
      </Button>
      <Button
        style={{
          padding: "10px",
      ...
      >
        <FaPrint className="me-1" /> {t("aitests.buttons.print")}
      </Button>
    </Modal.Footer>
  </Modal>
  ...
  <Modal show={showCalendarModal} onHide={closeCalendarModal} centered size="md">
    <Modal.Header closeButton className="flex-column align-items-start" style={{ border: "none" }}>
      <Modal.Title className="fs-4 fw-bold mb-1">
        {t("aitests.modals.appointment")} {selectedTest?.id}
      </Modal.Title>
    </Modal.Header>
    ...
    <Modal.Body>
      {/* Calendar */}
      <div className="mb-4">
        <h6 className="mb-2 fw-bold">{t("aitests.labels.calendar")}</h6>
        <>
          <style>{`
      ...
      {/* Time */}
      <div className="mb-4">
        <h6 className="mb-2 fw-bold">{t("aitests.labels.time")}</h6>
      ...
      {/* Note */}
      <div className="mb-4">
        <h6 className="mb-2 fw-bold">{t("aitests.labels.note")}</h6>
        <Form.Control
          as="textarea"
          rows={7}
          placeholder={t("aitests.placeholders.writeHere")}
      ...
      {/* Providers */}
      <div className="mb-4">
        <h6 className="mb-2 fw-bold">{t("aitests.labels.providers")}</h6>
        <Form.Select
          value={selectedProvider}
          onChange={(e) => setSelectedProvider(e.target.value)}
          style={{ borderRadius: "12px" }}
        >
          <option value="">{t("aitests.placeholders.selectProvider")}</option>
    ...
    <Modal.Footer className="d-flex justify-content-center" style={{ border: "none", marginTop: "40px" }}>
      ...
      >
        {t("aitests.buttons.saveAppointment")}
      </Button>
    </Modal.Footer>
  </Modal>
</div>
